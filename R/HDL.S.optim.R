...
#'
#' @param ref.data A list of data matched to LD reference generated by \code{\link{HDL.S.joint.reduct.dim}}.
...
HDL.S.optim <- function(ref.data, N,
  ...
  HDL.S:::log.msg(sprintf("Optimization done in %.3f seconds.\n", time), log.file)
